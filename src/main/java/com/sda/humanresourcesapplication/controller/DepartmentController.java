...
import com.sda.humanresourcesapplication.service.DepartmentService;
...
public class DepartmentController {
    ...
    public ResponseEntity<String> findDepartmentsWithEmployees(@RequestBody List<Employee> employeeList) {
